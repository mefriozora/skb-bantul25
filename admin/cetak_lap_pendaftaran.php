...
<body>
      ...
      <?php
        $no=1;
              ...
              echo '<h3 style="text-align:center;">Laporan Pendaftaran Diterima <br> ' .$_GET['kelas'].' Paket '.$_GET['paket'].' Tahun '.$_GET['tahun'].'</h3>';       
             ...
             $pendaftaran = mysqli_query($connect, "SELECT * FROM tb_pendaftar WHERE YEAR(tgl_pendaftaran)='$tahun'AND paket_kesetaraan='$paket' AND kelas_kesetaraan='$kelas' AND status_pendaftar='Diterima'");
              ...
              echo '<h3 style="text-align:center;">Semua Laporan Pendaftaran Diterima </h3>';
          ...
          ?>
            ...
            <?php
              ...
              echo "<tr><td colspan='17'>Data tidak ada</td></tr>";
              }      
            ?>
          </table>
<br>&nbsp;
