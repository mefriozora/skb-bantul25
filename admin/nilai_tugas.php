<?php include_once "cek_session.php";
...
<div class="my-3 my-md-1">
  <div class="container">
    ...
    <form method="post">
      ...
      <?php
      $query = mysqli_query($connect, "SELECT  nilai_tugas FROM tb_nilai WHERE rombel_id='" . $_GET['idrombel'] . "' AND mapel_id='" . $_GET['idmapel'] . "'");
      $val = mysqli_num_rows($query);
      if ($val == 0) { ?>
        <button type="submit" name="tambah" class="btn btn-primary" role="button">Simpan<?= $val ?></button>
      <?php } else { ?>
