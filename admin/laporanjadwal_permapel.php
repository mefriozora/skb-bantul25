...
<div class="my-3 my-md-1">
  ...
  <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="../admin/lap_jadwal.php">Laporan Jadwal</a>
            </li>
            <li class="breadcrumb-item active">Laporan Jadwal Per Matapelajaran</li>
          </ol>
    <?php 
	  $no=1;
    ...
    <?php }} ?>
     <div class="">
        ...
        <div class="card-header">
            <h3 class="card-title">Laporan Jadwal Per MataPelajaran</h3>
          </div>
          <div class="table-responsive">
              <div class="modal-footer">
                <a href="print_lap_jadwal.php?id=<?php echo $data['rombel_id'] ?>"><button class="btn btn-success" type="submit">Cetak Laporan</button></a>
              </div>
