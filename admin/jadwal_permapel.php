  ...
  <ol class="breadcrumb">
    ...
    <table>
        ...
        <tr>
            ...
            <th style="text-align:left;" width="120px">: <?php echo $data1['ta_nama'] ?></th>
            <th style="text-align:left;" width="150px"> Nama Pamong Belajar </th>
            <th style="text-align:left;" width="300px">: <?php echo $data1['pamong_nama'] ?></th>
        </tr>
    </table>
    <?php }} ?>
    <form method="post">
