      ...
      <div class="">
        ...
        <div class="card-header">
          ...
          <div class="table-responsive">
			...
			$ta = @$_POST['ta'];
			$nilai = mysqli_query($connect, "SELECT n.*, s.nama_siswa, m.mapel_nama, m.mapel_kkm FROM tb_nilai n JOIN tb_siswa s ON n.nis=s.nis JOIN tb_mapel m ON n.mapel_id=m.mapel_id WHERE n.kelas_id='$kelas' AND n.ta_id='$ta' AND n.semester_id='$semester' ");
