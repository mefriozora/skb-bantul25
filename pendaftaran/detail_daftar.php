...
<?php 
$main_view= "<script>window.location.href='detail_daftar.php';</script>";
switch ($_GET["act"]){
default:
//INDEX======================================================================================================
?>
...
<?php
$sesi_no_daftar=$_SESSION['sesi_no_daftar'];
$sesi_no_induk=$_SESSION['sesi_no_induk'];
$sql=mysqli_query("select * from pendaftar where no_induk='$sesi_no_induk' AND no_pendaftar='$sesi_no_daftar'");
